...
easy.addEventListener("click",level1_mode);
medium.addEventListener("click",level2_mode);
hard.addEventListener("click",level3_mode);

word.innerHTML="SELECT LEVEL";


function level1_mode(event){
